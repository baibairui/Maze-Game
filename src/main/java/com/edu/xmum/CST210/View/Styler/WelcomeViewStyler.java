    ...
    public static void styleVbox(Skin skin, VBox box) {
        ...
        switch (skin) {
            case V1 -> {
                ...
                Image backgroundImage = new Image("/com/edu/xmum/CST210/background/zombie1.gif");
            ...
            case V2 -> {
                ...
                Image backgroundImage = new Image("/com/edu/xmum/CST210/background/maze1.png");
                BackgroundImage bgImage = new BackgroundImage(
                        backgroundImage,
                        BackgroundRepeat.NO_REPEAT,
                        BackgroundRepeat.NO_REPEAT,
            ...
            case V3 -> {
                ...
                Image backgroundImage = new Image("/com/edu/xmum/CST210/background/pikachu1.gif");
                BackgroundImage bgImage = new BackgroundImage(
                        backgroundImage,
                        BackgroundRepeat.NO_REPEAT,
                        BackgroundRepeat.NO_REPEAT,
