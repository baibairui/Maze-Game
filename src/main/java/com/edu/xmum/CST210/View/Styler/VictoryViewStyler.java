...
public class VictoryViewStyler {
    ...
    public static void VboxStyle(Skin skin, VBox box) {
        ...
        switch (skin) {
            case V1 -> {
                ...
                Image backgroundImage = new Image("/com/edu/xmum/CST210/background/zombie4.gif");
            ...
            case V2 -> {
                ...
                Image backgroundImage = new Image("/com/edu/xmum/CST210/background/maze4.gif");
                BackgroundImage bgImage = new BackgroundImage(
                        backgroundImage,
                        BackgroundRepeat.NO_REPEAT,
                        BackgroundRepeat.NO_REPEAT,
            ...
            case V3 -> {
                ...
                Image backgroundImage = new Image("/com/edu/xmum/CST210/background/pikachu4.jpg");
                BackgroundImage bgImage = new BackgroundImage(
                        backgroundImage,
                        BackgroundRepeat.NO_REPEAT,
                        BackgroundRepeat.NO_REPEAT,
    ...
    public static void LabelStyle(Skin skin, Label victoryLabel) {
        ...
        switch (skin) {
            case V1 -> {
                victoryLabel.setFont(new Font(48));
                victoryLabel.setStyle("-fx-font-size: 48px; -fx-font-weight: bold; -fx-text-fill: #0073e6; " +
